...
import { getSubscriptionsApi, approveSubscriptionApi } from '../../services/api';
    ...
    <div className="min-h-screen bg-slate-100 flex flex-col justify-between">
      ...
      {selectedSub && (
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white p-8 rounded-2xl max-w-md w-full shadow-xl border border-slate-200 relative">
