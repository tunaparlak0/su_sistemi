...
import { Gauge, UserPlus, CheckCircle, Users, Receipt, UserCheck, History } from 'lucide-react';

export default function AdminMenuGrid({ userRole }) {
  const navigate = useNavigate();

  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      
      {/* Yeni Admin Ekle (IT ve SUPERADMIN, ADMIN) */}
      ...
      {/* Fatura Kes / Sayaç Oku (Herkes görebilir) */}
      <button 
